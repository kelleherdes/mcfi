...
def estimate_coefficients(I, toeplitz1, toeplitz2, toeplitz3, autocor, q_d, k_width, b):  
...
def predict_frame(image1, image2, image3, k_width, ac_block):
    k_off  = int(k_width  / 2)
    ...
    A = estimate_coefficients(I2[:, :, 1], toeplitz1, toeplitz2, toeplitz3, autocor2, q_d, k_width, b)
...
def main():
    ...
    predicted = predict_frame(image1, image2, image3, k_width, ac_block)
